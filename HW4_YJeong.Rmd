...
<p style="margin-left:40px">: Even though the plots do not seem to be convergent to the trendline perfectly, there is no other apparent pattern in the plot above. Thus, we can say that Y appear to be a linear function of x. </p>
