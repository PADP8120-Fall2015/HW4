...
Surprisingly (when weighed against my initial expectations), for every $1.2k increase in teacher pay, we can predict a -4.8 reduction in average combined SAT score.
